...
function.stateinctax<-function(data
    ...
    # Indicator variable for whether or not deduct federal income tax and Exemptions as credits
    data<-data %>% 
    ...
    data$income.base<-data$income.base+data$income.investment-data$Standard-data$PersonalExemption*data$deductPExemption-data$DependentExemption*data$numkids*data$deductDExemption-data$fedincometax*data$deductfedtax # adjust countable income
